...
// export CLOUDINARY_URL="cloudinary://823835466965732:aHCOestXEAQwPSPZ2p0VIFwmTi8@huksxnvej"
cloudinary.config({
    cloud_name: "huksxnvej",
    api_key: "823835466965732",
    api_secret: "aHCOestXEAQwPSPZ2p0VIFwmTi8"
    });
if (!process.env.CLOUDINARY_URL) {
    ...
    // console.error('*******************************************************************************')
    // process.exit(1)
    process.env.CLOUDINARY_URL="cloudinary://823835466965732:aHCOestXEAQwPSPZ2p0VIFwmTi8@huksxnvej"
}
// console.log("-----", process.env.CLOUDINARY_URL)
...
const doUpload = (publicId, req, res, next) => {
	...
	const uploadStream = cloudinary.uploader.upload_stream(result => {
		...
		//  console.log("in doUpload-----set req.fileurl", req.fileurl)
